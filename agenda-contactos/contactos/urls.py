from django.urls import path #Ruta para django
from . import views 

#Urls de Lista,Nuevo,Detalle,Editar,Eliminar + test para probar la url
urlpatterns = [
    ...
    path('test/', views.test_view, name='test_view')  #prueba de html para el django
